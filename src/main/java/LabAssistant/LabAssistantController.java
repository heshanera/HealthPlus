...
public class LabAssistantController extends AnchorPane {
    ...
    public LabAssistantController(String username) {
        ...
        labAssistant.saveLogin(username);
    ...
    public void fillPieChart() {
        ...
        ArrayList<ArrayList<String>> data = labAssistant.lastMonthsReports(12);
    ...
    public void showReport(String reportID)
    {
        ...
        if ( reportID.substring(0,2).equals("ur") ) {
            ...
            data = labAssistant.getUrineFullReport(reportID);
            type = "ur";

        } else if ( reportID.substring(0,2).equals("li") ) {

            data = labAssistant.getLipidTestReport(reportID);
            type = "li";

        } else if ( reportID.substring(0,2).equals("bg") ) {

            data = labAssistant.getBloodGroupingRh(reportID);
            type = "bg";

        } else if ( reportID.substring(0,3).equals("cbc") ) {

            data = labAssistant.getCompleteBloodCount(reportID);
            type = "cbc";

        } else if ( reportID.substring(0,2).equals("lv") ) {

            data = labAssistant.getLiverFunctionTest(reportID);
            type = "lv";

        } else if ( reportID.substring(0,2).equals("re") ) {

            data = labAssistant.getRenalFunctionTest(reportID);
            type = "re";

        } else if ( reportID.substring(0,4).equals("scpt") ) {

            data = labAssistant.getSeriumCreatinePhosphokinaseTotal(reportID);
            type = "scpt";

        } else if ( reportID.substring(0,3).equals("scp") ) {

            data = labAssistant.getSeriumCreatinePhosphokinase(reportID);
            type = "scp";

        }

        if (data.size() > 1){
            displayStage(data, type);
        } else {
    ...
    @FXML public void searchAppointment()
    {
        if ("Appointment ID".equals(serachType.getValue().toString()))
        {
            ...
            ArrayList<ArrayList<String>> data =  labAssistant.getPatientDetails(appID);
    ...
    private void displayStage(ArrayList<ArrayList<String>> data, String type) {
        LabReportPreviewController preview = new LabReportPreviewController(labAssistant);
    ...
    public void fillLabAppiontments()
    {
        ...
        ArrayList<String> data = labAssistant.lastMonthsAppointments();
    ...
    {
        String apps = labAssistant.getTodayAppointments();
    ...
    public void setAppointments()
    {
        ...
        ArrayList<ArrayList<String>> tableData0 = labAssistant.getAppointments();
    ...
    */
     ...
     */
        ...
        String result =   labAssistant.UrineFullReport(appID,appearance,sgRefractometer,ph,protein,glucose,ketoneBodies,bilirubin,
    ...
    @FXML private void saveLipidTest()
    {
        ...
        String result =  labAssistant.LipidTest(appointmentId,cholestrolHDL,cholestrolLDL,triglycerides,totalCholestrolLDLHDLratio );
    ...
    @FXML private void saveBloodGroupTest()
    {
        ...
        String result =  labAssistant.BloodGroupingTest(appointmentId,bloodG,rhD);
    ...
    @FXML private void saveCompleteBlood()
    {
        ...
        String result = labAssistant.completeBloodCount(appointmentId,totalWhiteCellCount,differentialCount,neutrophils,lymphocytes,monocytes,
    ...
    @FXML private void saveRenalTest()
    {
        ...
        String result = labAssistant.RenalFunctionTest(appointmentId,creatinine,urea,totalBilirubin,directBilirubin,sgotast,sgptalt,alkalinePhospates );
    ...
    @FXML private void saveCreatineTest()
    {
        ...
        String result = labAssistant.SeriumCreatinePhosphokinaseTotal(appointmentId,cpkTotal);
    ...
    @FXML private void saveHIV()
    {
        ...
        String result = labAssistant.SeriumCreatinePhosphokinase(appointmentId,hiv12ELISA);
    ...
    @FXML private void saveLiverFunctionTest()
    {
        ...
        String result = labAssistant.liverFunctionTest(appointmentId,totalProtein,albumin,globulin,totalBilirubin,directBilirubin,sgotast,
    ...
    {
        CurrentUserSummaryController user = new CurrentUserSummaryController(labAssistant);
        user.load();
    ...
    @FXML public void  editProfilePic() throws MalformedURLException, IOException
    {
        ...
        if ( editProfilePicButton.getText().equals("Edit") )
        {
            ...
            labAssistant.setProfilePic(imageName);
    ...
    public void loadProfileImage()
    {
        Image img;
        try{
            String image = labAssistant.getProfilePic();
    ...
    private void showAllMessages() throws IOException {
        ...
        AllMessagesController popup = new AllMessagesController(labAssistant);
        popup.loadMessages();
    ...
    public void loadProfileData()
    {
        ...
        HashMap<String,String> docPersonalInfo =  labAssistant.getProfileInfo();
    ...
    private void editBasicInfo()
    {
        ...
        else if ( currentState.equals("Save"))
        {
            ...
            boolean success = labAssistant.updateProfileInfo(info);
    ...
    private void editLabInfo()
    {
        ...
        else if ( currentState.equals("Save"))
        {
            ...
            boolean success = labAssistant.updateLabAssistantInfo(info);
            if (success == true) showSuccessIndicator();
    ...
    private void editUserInfo()
    {
        ...
        else if ( currentState.equals("Save"))
        {
            ...
            boolean success = labAssistant.updateAccountInfo(info);
            if (success == true) showSuccessIndicator();
    ...
    {
        Stage stage= new Stage();
        LogoutController logout = new LogoutController(logoutButton, labAssistant);
