...
public class AddNewDrugController extends AnchorPane {
    ...
    @FXML
    private ComboBox<String> genericName;
    @FXML
    private ComboBox<String> brandName;
    @FXML
    private ComboBox<String> drugType;
    @FXML
    private ComboBox<String> drugUnit;
    @FXML
